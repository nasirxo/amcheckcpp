...
set zeroaxis ls 1.5 dt 2 lw 2.5 lc rgb "gray"
set xtics font "Arial-Bold,26"
set ytics font "Arial-Bold,26"
...
plot \
    ...
    'BAND_bands_with_arrows.dat' using 1:($5 + ($6-$5)/2):7 with labels offset 6,0 font 'Arial,18' tc rgb 'blue' notitle
